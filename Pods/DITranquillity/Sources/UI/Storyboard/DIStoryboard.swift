...
public final class DIStoryboard: _DIStoryboardBase {
  ...
  public override func instantiateViewController(withIdentifier identifier: String) -> UIViewController {
    let customViewControllerAlert = super.instantiateViewController(withIdentifier: identifier)
    resolver?.inject(into: customViewControllerAlert)
    return customViewControllerAlert
  }
